//Idea: https://github.com/Totenfluch/StoreParticleExtension
...
public Action Command_Hide(int client, int args)
{
	...
	if (g_bHide[client])
	{
		CPrintToChat(client, "%s Particles disabled", g_sChatPrefix); //todo translate
		SetClientCookie(client, g_hHideCookie, "1");
	}
	else
	{
		CPrintToChat(client, "%s Particles enabled", g_sChatPrefix);
